        ...
        <div className="overflow-hidden shadow-2xl shadow-gray-300 lg:w-[80%] m-auto lg:mt-10 text-xs lg:text-[1rem]">
            <table className="border-collapse">
                <tr className="bg-gray-100">
                    <TableTh className="text-emerald-800">Service Pillar</TableTh>
                    <TableTh className="text-emerald-800">Key Focus & Features</TableTh>
                    <TableTh className="text-emerald-800">Primary Benefit</TableTh>
                    <TableTh className="text-emerald-800">Recommended Call to Action</TableTh>
                </tr>
                <tr className="bg-gray-300">
                    ...
                    <TableTd><a href="#" className="text-emerald-800 font-semibold">View Full Class Schedule</a></TableTd>
                </tr>
                <tr className="bg-gray-100">
                    ...
                    <TableTd><a href="#" className="text-emerald-800 font-semibold">Book a Free Consultation</a></TableTd>
                </tr>
                <tr className="bg-gray-300">
                    ...
                    <TableTd><a href="#" className="text-emerald-800 font-semibold">Take a Virtual Tour</a></TableTd>
                </tr>
                <tr className="bg-gray-100">
                    ...
                    <TableTd><a href="#" className="text-emerald-800 font-semibold">Join the Avsar Tribe</a></TableTd>
                </tr>
            </table>
        </div>
    )

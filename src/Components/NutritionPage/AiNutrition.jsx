    ...
    return (<>
        <div>
            <Heading heading="Build Your Custom AI Meal Blueprint"
                ...
                paragraph="Stop relying on rigid, one-size-fits-all diet charts that don't fit your
             daily routine. Input your target calories, fitness goals, and dietary preferences to
